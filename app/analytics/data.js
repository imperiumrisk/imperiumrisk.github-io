...
const irfList = [
	{
		...
		data: [
			...
			{label: "Product Complexity", slider_id: "prodComp1Slider", output_id: "prodComp1Out", min: 0.1, max: 1, step: 0.1, init: 0.5, current: 0.5, last_month: 0.4, last_year:0.4, predicted: 0.2},
			...
			{label: "Employees", slider_id: "employees1Slider", output_id: "employees1Out", min: 0.1, max: 1, step: 0.1, init: 0.3, current: 0.3, last_month: 0.5, last_year: 0.5, predicted: 1},
