...
const controlList = [
	...
	},
	{
		...
		data: [
			...
			{label: "Database Security (1)", checkbox_id: "fixDBSec1", current: 0, init: 0, max: 1, last_month: 0, last_year: 0, predicted: 0.1, type:"direct_preventative"},
			...
			{label: "Payment Controls", checkbox_id: "fixPaymentControl", current: 0, init: 0, max: 1, last_month: 0, last_year: 0, predicted: 0.1, type:"direct_preventative"},
	...
	},
	{
		...
		data: {
			...
			poisson: [
				...
				{label: "Payment System Complexity", weight: 0},
				{label: "Access Control (1)", weight:0},
				{label: "Penetration Tests", weight:0},
				{label: "Phising Training (1)", weight:0},
				{label: "Access Control (2)", weight:0},
				{label: "Data Security Policy", weight:0},
				{label: "Spreadsheets", weight:0},
